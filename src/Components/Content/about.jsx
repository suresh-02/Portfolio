...
const About = () => {
  return (
    <div id="about" className="w-full flex justify-center  bg-white py-16 h-max-content md: h-[100vh] ">
      <div className="sm:  justify-between  grid md:grid-cols-2 gap-[80px] px-[100px]">
        ...
        <div className="flex flex-col justify-center  ">
          ...
          <p className="font-bold text-left md:text-[20px] md:mx-0 py-4 leading-10 mt-10">
