...
const About = () => {
  return (
    ...
    <div id="about" className="w-full h-[100vh] flex flex-coljustify-center bg-black mt-[90px]  px-8">
      <div className=" mx-auto flex md:flex-cols-2  gap-[40px]z justify-center items-center">
        ...
        <div className="flex flex-col justify-center  ">
          <h1 className="text-[60px] text-[#eb5939] md:text-[#eb5939] ml-[20px] font-bold text-6xl text-left py-[20px] border-b-[#00df9a] relative before:content-[''] before:absolute before:block before:w-full before:h-[2px] 
