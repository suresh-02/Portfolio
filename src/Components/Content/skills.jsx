...
import { TbBrandNextjs, TbBrandTailwind , TbBrandAngular , TbBrandTypescript} from "react-icons/tb";
import { SiMysql,SiMongodb,SiChakraui } from "react-icons/si";

export default function skills() {
  return (
    <div className="pt-[250px] flex flex-col justify-center  mx-auto h-max-content md:h-[100vh]" id="skills">
      <h1 className=" text-6xl font-bold mb-[80px] max-w-max mx-auto text-[#eb5939] relative before:content-[''] before:absolute before:block before:w-full before:h-[2px] 
